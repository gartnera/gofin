...
func (_q *LibraryQuery) QueryItems() *MediaItemQuery {
...
func (_q *LibraryQuery) WithItems(opts ...func(*MediaItemQuery)) *LibraryQuery {
	query := (&MediaItemClient{config: _q.config}).Query()
...
func (_q *LibraryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Library, error) {
	...
	if query := _q.withItems; query != nil {
		if err := _q.loadItems(ctx, query, nodes,
			func(n *Library) { n.Edges.Items = []*MediaItem{} },
			func(n *Library, e *MediaItem) { n.Edges.Items = append(n.Edges.Items, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *LibraryQuery) loadItems(ctx context.Context, query *MediaItemQuery, nodes []*Library, init func(*Library), assign func(*Library, *MediaItem)) error {
