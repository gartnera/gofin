...
func (_q *UserQuery) QueryTokens() *AccessTokenQuery {
	query := (&AccessTokenClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithTokens(opts ...func(*AccessTokenQuery)) *UserQuery {
	query := (&AccessTokenClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withTokens; query != nil {
		if err := _q.loadTokens(ctx, query, nodes,
			func(n *User) { n.Edges.Tokens = []*AccessToken{} },
			func(n *User, e *AccessToken) { n.Edges.Tokens = append(n.Edges.Tokens, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadTokens(ctx context.Context, query *AccessTokenQuery, nodes []*User, init func(*User), assign func(*User, *AccessToken)) error {
