...
// AddTokens adds the "tokens" edges to the AccessToken entity.
func (_u *UserUpdate) AddTokens(v ...*AccessToken) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearTokens clears all "tokens" edges to the AccessToken entity.
func (_u *UserUpdate) ClearTokens() *UserUpdate {
	_u.mutation.ClearTokens()
	return _u
}

// RemoveTokenIDs removes the "tokens" edge to AccessToken entities by IDs.
func (_u *UserUpdate) RemoveTokenIDs(ids ...int) *UserUpdate {
	_u.mutation.RemoveTokenIDs(ids...)
	return _u
}

// RemoveTokens removes "tokens" edges to AccessToken entities.
func (_u *UserUpdate) RemoveTokens(v ...*AccessToken) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddTokens adds the "tokens" edges to the AccessToken entity.
func (_u *UserUpdateOne) AddTokens(v ...*AccessToken) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveTokens removes "tokens" edges to AccessToken entities.
func (_u *UserUpdateOne) RemoveTokens(v ...*AccessToken) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
